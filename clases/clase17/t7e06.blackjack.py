...
def barajar(b: list) -> list:
    ...
    for i in range(2000):
        ...
        baraja_desordenada[pos1], baraja_desordenada[pos2] = baraja_desordenada[pos2], baraja_desordenada[pos1]
    return baraja_desordenada
